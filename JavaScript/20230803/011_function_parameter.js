...
test(10, 20); // 모자라면 undefined
test(10, 20, 30, 40); // 넘기면 제대로 작동한다.

// default value
function test(a = 10, b = 20, c = 30) { // 아무 값도 안넣었을때 default
    console.log(a, b, c);
    return a + b + c;
}
...
// 기본값 설정하는 방법
function player({scene = '플레이신', y = 200, x = 100,texture = '슬라임',animKey = '슬라임_애니',initHp = 100,dropRate = 0.1}) {
