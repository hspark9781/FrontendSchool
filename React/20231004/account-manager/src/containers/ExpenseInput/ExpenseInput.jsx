...
export default function ExpenseInput() {
    ...
    const [name, setName] = useState(''); // 지출 이름을 관리합니다.
    const [price, setPrice] = useState(0); //지출금액을 관리합니다.
    ...
    return (
        ...
        <div>
            <label>
                지출상품 명 : 
                <input type="text" placeholder='예 : "사과"' on onChange={(event) => setName(event.target.value)}/>
            </label>
        </div>
        <div>
                <label>
